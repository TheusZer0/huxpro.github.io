...
lo cargamos en bloodhound usando **cargar la data**. esto te puede mostrar cual es el comando para obtenter o explotar la vuln con **Find principal with DCSync** 
